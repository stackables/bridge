...
Get syntax highlighting for [Visual Studio Code](https://marketplace.visualstudio.com/items?itemName=stackables.bridge-syntax-highlight). [Full language guide is here.](./docs//bridge-language-guide.md)
