...
15. [Path Scoping Blocks (Nested Objects)](#15-path-scoping-blocks-nested-objects)
16. [Tool Inheritance](#16-tool-inheritance)
17. [Force Statement (`force <handle>`)](#17-force-statement-force-handle)
18. [Built-in Tools](#18-built-in-tools)
