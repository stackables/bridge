...
| **`@stackables/bridge-compiler`** | **The Compiler**   | Compiling BridgeDocument into optimized JavaScript code.                           |
...
```bash
npm install @stackables/bridge-graphql @stackables/bridge-parser graphql
```

```typescript
import { parseBridgeDiagnostics } from "@stackables/bridge-parser";
