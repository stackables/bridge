...
description: How to choose the right Bridge packages for your use case to optimize bundle size and deployment.
---
...
1. **The Build Step (Dev/CI)**
   Install the parser as a dev dependency so it never touches your production bundle.
