...
- [Performance log](https://github.com/stackables/bridge/blob/main/docs/performance.md) - This is where we document all optimisations (both failed and successful)
- Profiling scripts:
