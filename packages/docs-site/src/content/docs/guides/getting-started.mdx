...
1. Install bridge compiler and runtime
   ...
   _(Note: For production edge deployments, you can optimize your bundle size by installing individual packages. See our [Package Selection](/advanced/packages) guide.)_
...
3. Wrap your Schema with The Bridge
   ...
   You can use any standard GraphQL server (like Apollo or Yoga). bridgeTransform takes your raw schema and automatically attaches the compiled bridge document as the resolvers.
