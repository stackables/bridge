...
1. Install bridge compiler and runtime
    ...
    ```
    *(Note: For production edge deployments, you can optimize your bundle size by installing individual packages. See our [Package Selection](/advanced/packages) guide.)*
