...
<MiniPlaygroundModal client:load exampleId="tool-inheritance" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="const-blocks" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="define-blocks" autoRun={true} />
