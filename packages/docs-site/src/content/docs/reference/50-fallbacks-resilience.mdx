...
<MiniPlaygroundModal client:load exampleId="safe-execution" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="control-flow-throw-panic" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="weather-overdefinition" autoRun={true} />
