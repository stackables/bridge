...
<MiniPlaygroundModal client:only="react" exampleId="safe-execution" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="control-flow-throw-panic" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="weather-overdefinition" autoRun={true} />
