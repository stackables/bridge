...
<MiniPlaygroundModal client:load exampleId="string-interpolation" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="expressions" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="boolean-logic" autoRun={true} />
...
<MiniPlaygroundModal client:load exampleId="ternary" autoRun={true} />
