...
Standard JavaScript math precedence applies (multiplication/division before addition/subtraction, and comparisons last). You can chain as many operators as you need.
