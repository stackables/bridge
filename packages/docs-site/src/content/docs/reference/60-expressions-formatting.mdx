...
<MiniPlaygroundModal client:only="react" exampleId="string-interpolation" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="expressions" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="boolean-logic" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="ternary" autoRun={true} />
