...
<MiniPlaygroundModal client:only="react" exampleId="sbb-train-search" autoRun={false} />
...
<MiniPlaygroundModal client:only="react" exampleId="memoized-loop-tools" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="control-flow-break-continue" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="array-filter" autoRun={true} />
...
<MiniPlaygroundModal client:only="react" exampleId="array-fanout" autoRun={false} />
